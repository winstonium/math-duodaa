...
*/
	...
	return array(
		...
		'a_selected_body' => "<font style=\"color: #F00; font-weight: bold; font-size: 18px; font-family: Verdana, Geneva, sans-serif;\">系统邮件，请不要回复！</font><br/><br/>祝贺! 你在^site_title的回复被 ^s_handle选为最佳答案:<br/><br/>^open^a_content^close<br/><br/> 问题:<br/><br/>^open^q_title^close<br/><br/>点击链接查看问题:<br/><br/><a href='^url'>^url</a>谢谢,^site_title <br/><br/><font style=\"color: #F00; font-weight: bold; font-size: 18px; font-family: Verdana, Geneva, sans-serif;\">系统邮件，请不要回复本邮件！</font><br/><br/>",
