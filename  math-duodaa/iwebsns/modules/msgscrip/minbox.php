 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/modules/msgscrip/minbox.html
...
if(filemtime("templates/duodaa_temp/modules/msgscrip/minbox.html") > filemtime(__file__) || (file_exists("models/modules/msgscrip/minbox.php") && filemtime("models/modules/msgscrip/minbox.php") > filemtime(__file__)) ) {
	tpl_engine("duodaa_temp","modules/msgscrip/minbox.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<?php foreach($msg_inbox_rs as $key => $val){?>
        <tr>
            ...
            <td width="20"><a href='do.php?act=msg_del&id=<?php echo $val["mess_id"];?>&t=0' onclick='return confirm("<?php echo $m_langpackage->m_del_ask;?>");'><img title="<?php echo $m_langpackage->m_del;?>" src="skin/default/jooyea/images/del.png" /></a></td>
		</tr>
<?php }?>
</table>
<div class="rs_head <?php echo $show_data;?>">
