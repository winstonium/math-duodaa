 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/modules/mypals/pals_invite.html
...
if(filemtime("templates/duodaa_temp/modules/mypals/pals_invite.html") > filemtime(__file__) || (file_exists("models/modules/mypals/pals_invite.php") && filemtime("models/modules/mypals/pals_invite.php") > filemtime(__file__)) ) {
	tpl_engine("duodaa_temp","modules/mypals/pals_invite.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<table class="msg_inbox">
    ...
    <td width="25"><input name="attach[]" type="checkbox" value="<?php echo $rs['id'];?>" /></td>
		...
		<td><a href='modules.php?app=mypals_invite&del_code=1&id=<?php echo $rs['id'];?>'><img src="skin/default/jooyea/images/del.png" /></a></td>
	</tr>
	<?php }?>
</table>
</form>
