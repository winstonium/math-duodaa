 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/modules/share/share_list.html
...
<script type='text/javascript'>
	...
	function add_out_share(){
		...
		if(trim(outer_re)&&trim(outer_re)!='http://'){
			...
			diag.InnerHtml= '<div class="loading"><img src="skin/default/jooyea/images/loading.gif"><?php echo $s_langpackage->s_data_loading;?>...</div>';
			diag.show();
