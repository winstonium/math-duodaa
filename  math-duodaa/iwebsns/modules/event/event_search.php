 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/modules/event/event_search.html
...
if(filemtime("templates/duodaa_temp/modules/event/event_search.html") > filemtime(__file__) || (file_exists("models/modules/event/event_search.php") && filemtime("models/modules/event/event_search.php") > filemtime(__file__)) ) {
	tpl_engine("duodaa_temp","modules/event/event_search.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
