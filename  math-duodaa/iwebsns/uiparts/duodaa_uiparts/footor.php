 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/uiparts/footor.html
...
<div class="foot">
	<a href="/?qa=about"><?php echo $pu_langpackage->pu_about_us;?></a>
	...
	<!--<a href="mailto:<?php echo $adminEmail;?>"><?php echo $pu_langpackage->pu_email;?></a>-->
	Powered by <strong>iWeb<b>SNS</b></strong></div>
