<%@ Page language="c#" Inherits="zhidao.mytw" CodeFile="mytw.aspx.cs" %>
...
<HTML>
	<HEAD>
		<title>我的提问-<%=Application["CnWebName"]%></title>
						...
						<div class="leftdiv">
							...
							<asp:DataGrid id="Grid1" runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="sh" HeaderText="审核" DataFormatString="&lt;img src='images/dd_{0}.gif'&gt;&lt;br&gt;&lt;hr size=1 color=#eae6e8&gt;">
										<HeaderStyle Width="40px"></HeaderStyle>
									</asp:BoundColumn>
