 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/uiparts/homeheader.html
...
if(filemtime("templates/duodaa_temp/uiparts/homeheader.html") > filemtime(__file__) || (file_exists("models/uiparts/homeheader.php") && filemtime("models/uiparts/homeheader.php") > filemtime(__file__)) ) {
	tpl_engine("duodaa_temp","uiparts/homeheader.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
