 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/modules/mypals/search_pals.html
...
if(filemtime("templates/duodaa_temp/modules/mypals/search_pals.html") > filemtime(__file__) || (file_exists("models/modules/mypals/search_pals.php") && filemtime("models/modules/mypals/search_pals.php") > filemtime(__file__)) ) {
	tpl_engine("duodaa_temp","modules/mypals/search_pals.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
