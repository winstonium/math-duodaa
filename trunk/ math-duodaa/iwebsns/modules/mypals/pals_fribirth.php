 ...
 * 如果您的模板要进行修改，请修改 templates/duodaa_temp/modules/mypals/pals_fribirth.html
...
if(filemtime("templates/duodaa_temp/modules/mypals/pals_fribirth.html") > filemtime(__file__) || (file_exists("models/modules/mypals/pals_fribirth.php") && filemtime("models/modules/mypals/pals_fribirth.php") > filemtime(__file__)) ) {
	tpl_engine("duodaa_temp","modules/mypals/pals_fribirth.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php	
   ...
   <div class="sideitem_head"><h4><?php echo $mp_langpackage->mp_pal_birth;?></h4><a href="modules.php?app=mypals_fribirth_month" target='frame_content'><?php echo $mp_langpackage->mp_more;?></a></div>
       ...
       <ul id='pals_fribirth' class="userlist">
		...
		<li>
			...
			<span><img style="cursor:pointer;" onclick="<?php echo $send_hi;?>(<?php echo $val["user_id"];?>)" src="skin/default/jooyea/images/hi.gif" title="<?php echo $f_langpackage->f_greet;?>" /></span>
		</li>
		<?php }?>
		</ul>
    </div>
