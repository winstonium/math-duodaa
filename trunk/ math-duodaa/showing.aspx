<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="showing.aspx.cs" Inherits="showing" %>
...
<script type="text/javascript" src="MathJax/MathJax.js"></script>
    ...
    <asp:Label runat="server" Text="请输入问题链接" Font-Size="Small" />
    ...
    <br />
    <asp:Label ID="Label1" runat="server" Text="目前支持百度知道的问题链接。" Font-Size="X-Small" 
					...
					<td width="570" valign="top">
						<div class="leftdiv" id="qDetail" runat="server">
							<table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
									<td align="right"><font color="green" style="font-size:x-small">此问题来自<asp:label id="Label2" runat="server"></asp:label>,原问题中可能含有图片并未在此显示</font><font color="blue" style="font-size:x-small"><asp:HyperLink
