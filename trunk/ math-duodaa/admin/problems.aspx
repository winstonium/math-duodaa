<%@ Page language="c#" Inherits="zhidao.admin.problems" CodeFile="problems.aspx.cs" %>
			...
			<TABLE id="Table1" border="0" width="800">
					...
					<TD colSpan="2">
						<asp:DataGrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="15"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="state" HeaderText="状态" DataFormatString="&lt;img src=&quot;../images/state_{0}.gif&quot;&gt;">
									<HeaderStyle Width="40px"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="answer" HeaderText="回答">
									<HeaderStyle Width="40px"></HeaderStyle>
								</asp:BoundColumn>
				...
				<TR>
					<TD>
						...
						<asp:Label id="Label1" runat="server"></asp:Label><FONT face="宋体">条提问。</FONT></TD>
					<TD>
