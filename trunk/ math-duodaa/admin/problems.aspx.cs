...
namespace zhidao.admin
{
	...
	public partial class problems : System.Web.UI.Page
	{
		...
		private void band(string _key)
		{
			...
			OleDbDataAdapter mydata=new OleDbDataAdapter("select a.id,a.caption,b.username,a.sj,a.state,a.answer from problems a,users b where a.userid=b.id and a.caption like '%"+_key+"%'",conn);
		...
		protected void Button1_Click(object sender, System.EventArgs e)
		{
			...
			{ 
				...
				{ 
					...
					string strSql3 = "delete from answer where problemsid in (" + strDNews + ")";
					conn.Open(); 
