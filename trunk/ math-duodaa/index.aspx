			...
			<table width="800" cellpadding="5" cellspacing="0" border="0">
				<tr>
					<td width="570" valign="top">
						<div class="leftdiv">
							<div align="left">
								<asp:Button id="Button1" runat="server" Text="全部问题" Font-Bold="True" onclick="Button1_Click"></asp:Button>
								<asp:Button id="Button2" runat="server" Text="已解决" onclick="Button2_Click"></asp:Button>
								<asp:Button id="Button3" runat="server" Text="待解决" onclick="Button3_Click"></asp:Button></div>
							...
							<asp:DataGrid id="Grid1" runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True"
								...
								<Columns>
                                    ...
                                    <asp:BoundColumn DataField="prize" HeaderText="悬赏" DataFormatString="&lt;script type='text/javascript'&gt;document.write(showPrize('{0}'));&lt;/script&gt; &lt;br&gt;&lt;hr size=1 color=#eae6e8&gt;">
									...
									<asp:BoundColumn DataField="state" HeaderText="状态" DataFormatString="&lt;img src='images/state_{0}.gif'&gt;&lt;br&gt;&lt;hr size=1 color=#eae6e8&gt;">
										<HeaderStyle Width="40px"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="sj" HeaderText="提问时间" DataFormatString="&lt;script type='text/javascript'&gt;document.write(shijian('{0:yyyy-MM-dd hh:mm:ss}',curTime));&lt;/script&gt; &lt;br&gt;&lt;hr size=1 color=#eae6e8&gt;">
										<HeaderStyle Width="80px"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
								</Columns>
								<PagerStyle  VerticalAlign="Bottom" NextPageText="下一页" PrevPageText="上一页" HorizontalAlign="Center"
